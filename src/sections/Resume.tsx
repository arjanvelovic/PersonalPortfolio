...
function Resume() {
  ...
  return (
    <div className='h-full imagecover2'>
        <div className='grid text-center py-20 justify-items-center h-fit md:h-full' >
          <div className='my-0'>
          ...
          <div className='my-0'>
            <div className='mt-2 mx-2 h-fit'>
              <img src={resumeInfo['image']} className='resumepic border border-gray-300'/>
            </div>
